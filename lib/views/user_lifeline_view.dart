...
class UserLifeLineView extends StatelessWidget {
  ...
  /// Refill user hearts
  /// maximum refillable heart is lessThan 4
  /// 60 bits is deducted to refill users heart
  ...
  Widget build(context) {
    return Scaffold(
      ...
      appBar: kDebugMode ? AppBar(
        backgroundColor: Colors.transparent,
        leading: const CloseButton(key: lifeRefillModalDismissButtonKey),
      ) : null,
      body: Padding(
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Text(
                          hasRanOutOfLives ? "You have to refill your hearts to continue learning" : "You have $lives Hearts. Take on your next Challenge",
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    buildAdsWidget(
                      ...
                      OutlinedButton(
                        onPressed: lives < 3 ? () => _refillHearts(context) : null,
