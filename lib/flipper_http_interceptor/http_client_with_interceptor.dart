...
class HttpClientWithInterceptor implements http.BaseClient {
  ...
  @override
  Future<http.Response> put(Uri url, {Map<String, String>? headers, body, Encoding? encoding}) {
    return _withInterceptor(
      method: 'PUT',
      url: url.toString(),
      headers: headers,
  ...
  Future<bool> _reportRequest(
    ...
    final FlipperNetworkPlugin? flipperNetworkPlugin = FlipperClient.getDefault().getPlugin(FlipperNetworkPlugin.ID) as FlipperNetworkPlugin?;
  ...
  Future<bool> _reportResponse(String requestId, http.Response response) async {
    ...
    final FlipperNetworkPlugin? flipperNetworkPlugin = FlipperClient.getDefault().getPlugin(
      FlipperNetworkPlugin.ID,
